...
\begin{flalign}
\psi_\text{MMS} & = \sin \left(\frac{\pi}{2}r \right) \cos(\pi z).
...
& = 2 \pi \sin \left(\frac{\pi}{2}r \right) \cos(\pi z).
\end{flalign}

\noindent Given,
\begin{flalign}
\frac{\partial}{\partial r} \left[\sin \left(\frac{\pi}{2}r \right) \cos(\pi z) \right] & = \frac{\pi}{2} \cos \left(\frac{\pi}{2}r \right) \cos(\pi z), \\
\frac{\partial}{\partial z} \left[\sin \left(\frac{\pi}{2}r \right) \cos(\pi z) \right] & = - \pi \sin \left(\frac{\pi}{2}r \right) \sin(\pi z),
\end{flalign}
...
\end{figure}
%
Figure~\ref{fig:cP4C43MeshUnit} shows the same results on a $3^\text{rd}$-order mesh.
%
\begin{figure}[!htb]
\centering
\begin{tikzpicture}
