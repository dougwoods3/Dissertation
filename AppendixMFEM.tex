...
$+ \beta \left(\left| \vec{\Omega} \vd \hat{n} \right| \psi, v \right)_{\partial \mathcal{D}_k^e}$ \end{tabular} & DGTraceIntegrator$\left( \vec{\Omega}, \alpha, \beta \right) $ \\\hline
...
$+ \beta \left(\left| \vec{\Omega} \vd \hat{n} \right| \psi, v \right)_{\partial \mathcal{D}_k^b}$ \end{tabular} & DGTraceIntegrator$\left( \vec{\Omega}, \alpha, \beta \right) $ \\\hline
