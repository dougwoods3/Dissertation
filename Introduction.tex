...
We approximate the continuum of directions that particles can travel by assuming they only travel in discrete ordinate ($S_N$) directions. Figure~\ref{fig:DiscreteOrdinates} shows an example of a set of discrete ordinates.
%
\begin{figure}[!htb]
\centering
